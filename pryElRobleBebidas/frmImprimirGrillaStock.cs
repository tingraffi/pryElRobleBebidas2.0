...
{
    public partial class frmImprimirGrillaStock : Form
    {
        ...
        private void LoadData()
        {
            ...
            {
                connection.Open();
                string query = "SELECT Nombre, Marca, Tamaño, Envase, TipoBebidas, CodigoBebida, Cantidad, Proveedor, PrecioUnidad FROM Bebidas";
